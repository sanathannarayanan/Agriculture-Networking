...
<?php
include("menu.php");
$result = mysqli_query("SELECT * FROM profile ORDER BY RAND()
");
$i=0;
...
$i++;
  ...
  $result = mysqli_query("SELECT * FROM stuacc where id");

$strec = mysqli_query("SELECT * FROM stuacc WHERE email='$_SESSION[logid]' ");

while($row = mysqli_fetch_array($strec))
  {
$_SESSION["stuid"] =  $row["id"];

  }

$colrec = mysqli_query("SELECT * FROM profile WHERE userid='$_SESSION[stuid]' ");

while($row = mysqli_fetch_array($colrec))
  {
$cname = $row["coluni"];
  }

$acrec1 = mysqli_query("SELECT * FROM stuacc WHERE id='$uid[0]' ");

while($row = mysqli_fetch_array($acrec1))
  {
	  $stid1 = $row["id"];
$name1 = $row["firstname"];
$gen1= $row["iam"];
  ...
  $acrec2 = mysqli_query("SELECT * FROM stuacc WHERE id='$uid[1]' ");

while($row = mysqli_fetch_array($acrec2))
  {
	  	  $stid2 = $row["id"];
$name2 = $row["firstname"];
$gen2= $row["iam"];
  ...
  $acrec3 = mysqli_query("SELECT * FROM stuacc WHERE id='$uid[2]' ");

while($row = mysqli_fetch_array($acrec3))
  {
	  	  $stid3 = $row["id"];
$name3 = $row["firstname"];
$gen3= $row["iam"];
  ...
  $acrec4 = mysqli_query("SELECT * FROM stuacc WHERE id='$uid[3]' ");

while($row = mysqli_fetch_array($acrec4))
  {
	  	  $stid4 = $row["id"];
$name4 = $row["firstname"];
$gen4= $row["iam"];
