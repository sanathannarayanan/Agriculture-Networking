...
<?php
include("mysql.php");
$result1 = mysqli_query("SELECT * FROM college");
...
<tr>
	<td width="70%">
		...
		<h2>About Us</h2>
		The Agricultural Networking website is an online community designed to make your life as an agricultural student, farmer more active and stimulating. The Agricultural Networking can help you maintain existing relationships with agricultural students & farmers and share pictures, messages, and establish new ones by reaching out to people you've never met before, and also using this site, user can share knowledge, agriculture related materials, documents etc. </td>
...
<iframe height="430" width="700" src="https://bot.dialogflow.com/16fcaa08-162c-431b-aa35-6c6857f3c738"></iframe>
